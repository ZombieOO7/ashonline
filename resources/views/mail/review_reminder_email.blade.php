...
<body>
<form action="{{ url('review_store') }}" method="post">
...
<table width="800px" cellpadding="0" cellspacing="0"
    ...
    <tbody>
            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="#"><img src="{{ asset('frontend/images/templates/logo.png') }}"
       ...
       {{-- <tr>
           <td>
               <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#ebeff2;width: 100%;text-align: center;font-family: 'Poppins', sans-serif !important;">
                   <tbody>
                   <tr><td height="15px"></td></tr>
                   <tr><td style="font-family: 'Poppins', sans-serif !important;font-weight: bold;font-size: 38px;color: #000;">Hi </td></tr>
                   <tr><td style="font-family: 'Poppins', sans-serif !important;font-weight: 400;font-size: 20px;color: #616161;">{{ @$billingAddress->full_name }}</td></tr>
                   <tr><td height="15px"></td></tr>
                   </tbody>
               </table>
           </td>
                      ...
                      <tr>
                          ...
                          <td width="740px">
                              <table width="100%" cellpadding="0" cellspacing="0" style="width: 100%;font-family: 'Poppins', sans-serif !important;">
                                  <tbody>
                                    <tr><td style="text-align: center;font-family: 'Poppins', sans-serif !important;font-weight: 400;font-size: 14px;color: #616161;"><p><b>Hi {{ @$billingAddress->full_name }},</b></p></td></tr>

                                    <tr><td style="text-align: center;font-family: 'Poppins', sans-serif !important;font-weight: 400;font-size: 14px;color: #616161;"><p>You recently bought <span style="font-family: 'Poppins', sans-serif !important;font-weight: 600;font-size: 16px;color: #000000;padding-bottom: 10px;text-decoration: none;color: #2196f3;">{{ @$item->paper->title }}</span>, We hope you found it beneficial,</p></td></tr>

                                    <tr><td style="text-align: center;font-family: 'Poppins', sans-serif !important;font-weight: 400;font-size: 14px;color: #616161;"><p> We would be very greatful if you could leave us a short review below, Most of our customers find us through word of mouth and so reviews and recommendations are vitally important to us.</p></td></tr>
