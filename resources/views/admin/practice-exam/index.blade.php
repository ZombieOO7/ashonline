...
@section('title', __('formname.practice-exam.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.practice-exam.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('practice-exam.multi_delete')}}"
                                data-table_name="test_assessment_table" data-module_name="Practice Exam">{{__('formname.submit')}}</a>
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{Route('practice-exam.create')}}"
                ...
                <table class="table table-striped table-bordered table-hover table-checkable for_wdth" id="test_assessment_table"
                    data-url="{{ route('practice-exam.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.practice-exam.title')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.practice-exam.title')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
...
@section('inc_script')
<script>
var url = "{{ route('practice-exam.datatable') }}";
/** Show description modal */
...
<script src="{{ asset('backend/js/practice-exam/index.js') }}" type="text/javascript"></script>
@stop