...
@section('content')
@section('title', __('formname.examBoard.label'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.examBoard.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('examboard.multi_delete')}}"
                                data-table_name="faq_table" data-module_name="Exam Board">{{__('formname.submit')}}</a>
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth" id="faq_table"
                    data-type="" data-url="{{ route('examboard.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.examBoard.title')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.examBoard.title')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
...
@section('inc_script')
<script>
var url = "{{ route('examboard.datatable') }}";
</script>
<script src="{{ asset('backend/js/examboard/index.js') }}" type="text/javascript"></script>
@stop