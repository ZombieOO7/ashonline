                                ...
                                <tr>
                                    <td
                                        ...
                                        {{__('formname.order_id')}} : <span
                                            style="text-decoration: none;color: #2196f3;">{{@$orderItem->order->order_no}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="15px"></td>
                                                ...
                                                <tr>
                                                    <td width="130px">
                                                        ...
                                                        <p
                                                            ...
                                                            {{@date('d M Y',strtotime($orderItem->order->created_at))}}
                                                        </p>
                                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td
                                                        ...
                                                        <img src={{ @$orderItem->paper->thumb_path}} alt="{{ @$orderItem->paper->title }}" title="{{ @$orderItem->paper->title }}" width="200px" height="200px"></td>
                                                    <td
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="{{route('download',[@$orderItem->order->uuid,@$orderItem->paper->slug,@$versionId])}}"
