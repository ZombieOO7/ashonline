            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-wrapper">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="{{route('practice-topic-question.index')}}" class="btn btn-secondary m-btn m-btn--air m-btn--custom">
                                    <span>
                    ...
                    <div class="m-portlet__body">
                        <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post" action="{{route('practice-topic-question.importFile')}}" id="m_form_1" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="m-portlet__body">
                                ...
                                <div class="m-form__actions m-form__actions">
                                    <div class="row">
                                        <div class="col-lg-9 ml-lg-auto">
                                            ...
                                            <a href="{{route('practice-topic-question.index')}}" class="btn btn-secondary">{{__('formname.cancel')}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
