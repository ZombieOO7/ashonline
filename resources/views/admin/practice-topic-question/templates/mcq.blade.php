            ...
            <div class="m-portlet  m-portlet--full-height">
                ...
                <div class="m-form__group form-group row">
                    ...
                    <div class="m-radio-inline">
                        ...
                        <label class="m-radio">
                            <input type="radio" name="text[{{$key}}][answer_type]" value="2" class='answerType' data-index='{{$key}}' id="answer_type_{{$key}}" @if(@$question->answer_type == 2) checked @endif>{{__('formname.multiple_answer')}}
                            <span></span>
                        </label>
                    </div>
                    <span class="m-form__help"></span>
                ...
                @empty
                    @for($i=0; $i<$limit; $i++)
                        <div id='1_option_{{$i}}' class="form-group m-form__group row option_no_{{$i}}" style='display:{{($i==5 && $limit == 6)?'none':''}};'>
                            ...
                            @endphp
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                {!! Form::textarea($name,@$answer->answer,array('required'=>true,'id'=>'question_'.$key.'_answer'.$i,'class'=>'form-control m-input option-answers answer'.$key, 'required' => ($i==5)?'':'required','maxlength'=>'50', 'data-option'=>($i==5)?'false':'true', 'data-selected-ans' => $key)) !!}
                                <span class="inError"></span>
                            </div>
                ...
                <div class="form-group m-form__group row" >
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        {!! Form::textarea("text[".$key."][explanation]",@$question->explanation,array('class'=>'form-control m-input explanationEditor', 'id'=>'explanation'.$key)) !!}
                        <span class="inError"></span>
                    </div>
                </div>
                <div class="form-group m-form__group row">
            ...
            <div class="m-portlet  m-portlet--full-height">
                ...
                <div class="m-form__group form-group row">
                    ...
                    <div class="m-radio-inline">
                        ...
                        <label class="m-radio">
                            <input type="radio" name="text[1][answer_type]" value="2" class='answerType' data-index='0' id="answer_type_0" @if(@$question->answer_type == 2) checked @endif>{{__('formname.multiple_answer')}}
                            <span></span>
                        </label>
                    </div>
                    <span class="m-form__help"></span>
                ...
                @for($i=0; $i<$limit; $i++)
                    <div id='1_option_{{$i}}' class="form-group m-form__group row option_no_{{$i}}" style='display:{{($i==5 && $limit == 6)?'none':''}};'>
                        {!! Form::label(__('formname.option',['char'=>chr($alphabet)]).'*', null,array('class'=>'col-form-label col-lg-3 col-sm-12'))!!}
                        <div class="col-lg-6 col-md-9 col-sm-12">
                            {!! Form::textarea("text[1][answer][".$i."][answer]",null,array('required'=>true,'id'=>'question_1_answer'.$i,'class'=>'form-control m-input option-answers ckeditor answer1', 'required' => ($i==5)?'':'required','maxlength'=>'50', 'data-option'=>($i==5)?'false':'true', 'data-selected-ans' => 1)) !!}
                            <span class="inError"></span>
                        </div>
                        <div class="col-lg-3 col-sm-12">
                ...
                <div class="form-group m-form__group row">
                    {!! Form::label(__('formname.explanation'),null,array('class'=>'explanation col-form-label col-lg-3 col-sm-12'))!!}
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        {!! Form::textarea("text[1][explanation]",null,array('class'=>'form-control m-input explanationEditor', 'id'=>'explanation1')) !!}
                        <span class="inError"></span>
                    </div>
                </div>
                <div class="form-group m-form__group row">
