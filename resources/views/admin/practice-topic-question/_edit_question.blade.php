                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile"
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-wrapper">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="{{route('test-assessment.detail',['uuid'=>@$testAssessmentId])}}"
                    ...
                    <div class="m-portlet__body">
                        @if(isset($question) || !empty($question))
                            {{ Form::model($question, ['route' => ['assessment.question.list.store', @$question->uuid], 'method' => 'PUT','id'=>'m_form_1','class'=>'m-form m-form--fit m-form--label-align-right','enctype'=>'multipart/form-data']) }}
                        @else
                            {{ Form::open(array('route' => 'assessment.question.list.store','method'=>'POST','class'=>'m-form m-form--fit m-form--label-align-right','id'=>'m_form_1', 'files' => true, 'enctype'=>'multipart/form-data')) }}
                        @endif
                        <div class="m-portlet__body">
                            <div id="question-append">
                                ...
                                <div class="m-form__group form-group row" id='noOfOption' style="@if(@$question->type == 4) display:none; @endif">
                                    ...
                                    <div class="m-radio-inline">
                                        <label class="m-radio">
                                            <input type="radio" name="no_of_option" value="5" data-id='0_option_5' {{((count($answers) == 5) || $question==null)?'checked':''}}>5
                                            <span></span>
                                        </label>
                                        <label class="m-radio">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-5 col-md-9 col-sm-12 ml-3 mr-3">
                                    ...
                                    {{-- <div class="row row_img create-edit-preview">
                                        <img id="q_image_preview_0" src="{{@$question->image_path}}" alt="" height="200px" width="200px" style="display:{{isset($question->image_path)?'':'none'}};" />
                                    </div> --}}
                                    @error('question') <p class="errors">{{$errors->first('question')}}</p> @enderror
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-5 col-md-9 col-sm-12 ml-3 mr-3">
                                    ...
                                    {{-- <div class="row row_img create-edit-preview">
                                        <img id="q_image_preview_1" src="{{@$question->question_image_path}}" alt="" height="200px" width="200px" style="display:{{isset($question->question_image)?'':'none'}};" />
                                    </div> --}}
                                    @error('question') <p class="errors">{{$errors->first('question')}}</p> @enderror
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-5 col-md-9 col-sm-12 ml-3 mr-3">
                                    ...
                                    {{-- <div class="row row_img create-edit-preview">
                                    <img id="q_image_preview_2" src="{{@$question->answer_image_path}}" alt="" height="200px" width="200px" style="display:{{isset($question->answer_image)?'':'none'}};" />
                                    </div> --}}
                                    @error('question') <p class="errors">{{$errors->first('question')}}</p> @enderror
                                </div>
                            </div>
                            ...
                            @endif
                            {!! Form::hidden('test_assessment_id',@$testAssessmentId) !!}
                            {!! Form::hidden('question_id',@$question_id) !!}
                            {!! Form::hidden('test_assessment_subject_id',@$testAssessmentSubjectId) !!}
                                ...
                                <div class="m-form__actions m-form__actions">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 ml-lg-auto">
                                            ...
                                            <a href="{{route('test-assessment.detail',['uuid'=>@$testAssessmentId])}}" class="btn btn-secondary">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
