...
@php
if(isset($role)){
$title=trans('formname.role_update');
}
else{
$title=trans('formname.role_create');
}
@endphp
    ...
    <div class="m-content">
        <div class="row">
            ...
            <div class="m-portlet__body">
                ...
                @else
                {{ Form::open(array('route' => 'role_store','method'=>'POST','class'=>'m-form m-form--fit m-form--label-align-right','id'=>'m_form_1')) }}
                @endif
                <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    {!! Form::label(trans('formname.role_name').'*', null,array('class'=>'col-form-label
                    col-lg-3
                    col-sm-12')) !!}
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        {!!
                            Form::text('name',isset($role)?$role->name:'',array('class'=>'form-control
                            m-input')) !!}
                            @if ($errors->has('name')) <p style="color:red;">
                                ...
                                @if(isset($role))
                                @php $rolestatus = $role->status;@endphp
                                @else
                                @php $rolestatus = null;@endphp
                                @endif
                                <div class="form-group m-form__group row">
                                    {!! Form::label(trans('formname.status'), null,array('class'=>'col-form-label col-lg-3
                                    col-sm-12')) !!}
                                    <div class="col-lg-6 col-md-9 col-sm-12">
                                        {!! Form::select('status', ['1' => 'Active', '0' => 'Inactive'], $rolestatus,
                                        ['class' =>
                                        'form-control' ]) !!}
                                    </div>
                                </div>
