                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            <a href="{{route('student-topic-report.index')}}" class="btn btn-secondary m-btn m-btn--air m-btn--custom">
                                <span>
                    ...
                    <div class="m-portlet__body width_big users_details_scn">
                        ...
                        <div class="col-md-12">
                            <div class="">
                                ...
                                <div class="">
                                    <table class="table table-striped- table-bordered table-hover table-checkable" cellspacing="10" id="mock_test_table" data-url="{{route('test-topic-datatable')}}">
                                        <thead>
                                        <tr>
                                            <th class="">{{__('formname.q_topic')}}</th>
                                            <th class="">{{__('formname.score')}}</th>
                                            <th class="">{{__('formname.created_at')}}</th>
