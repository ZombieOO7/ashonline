                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption col-md-12">
                            {{ Form::open(array('route' => 'assessment.question.export','id'=>'m_form_1','method'=>'POST','class'=>'w-100'))}}
                            <div class="row">
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-tools">
                            <ul class="m-portlet__nav">
                                ...
                                <li class="m-portlet__nav-item">
                                    <a href="{{Route('assessment.question.import')}}"
...
@section('inc_script')
<script>
    var url = "{{route('assessment.question-datatable')}}";
