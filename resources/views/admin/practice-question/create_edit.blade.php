                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile"
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-wrapper">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="{{Route('assessment.question.index')}}"
                    ...
                    <div class="m-portlet__body">
                        @if(isset($question) || !empty($question))
                            {{ Form::model($question, ['route' => ['assessment.question.store', @$question->uuid], 'method' => 'PUT','id'=>'m_form_1','class'=>'m-form m-form--fit m-form--label-align-right','enctype'=>'multipart/form-data']) }}
                        @else
                            {{ Form::open(array('route' => 'assessment.question.store','method'=>'POST','class'=>'m-form m-form--fit m-form--label-align-right','id'=>'m_form_1', 'files' => true, 'enctype'=>'multipart/form-data')) }}
                        @endif
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row" id='typeData'>
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    ...
                                    ['class' => 'form-control', 'id' => 'type', 'data-url' => route('assessment.question.select'), 'data-question-id' => isset($question) ? $question->id : " ", 'data-subject-id' => isset($question) ? $question->subject_id : " " ]) !!}
                                <span class="inError"></span>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="m-form__actions m-form__actions">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 ml-lg-auto">
                                            ...
                                            <a href="{{Route('assessment.question.index')}}" class="btn btn-secondary">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
