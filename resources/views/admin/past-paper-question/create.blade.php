                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-wrapper">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="{{route('past-paper-question.index')}}"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    {!! Form::select("topic_id[]",@$topicList??[],@$question->topic_ids??[],['id'=>'topic', 'class' => 'form-control selectpicker', 'multiple'=>true]) !!}
                            ...
                            <div class="m-form__actions m-form__actions">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 ml-lg-auto">
                                        ...
                                        <a href="{{route('past-paper-question.index')}}" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
