            ...
            <div class="m-portlet__body width_big">
                <div class="m-form__content">
                    <form action="" id='getData'>
                        <div class="row">
                            <div class="col-sm-3">
                                <select name='student_id' class="form-control selectpicker" id='studentId' data-live-search="true">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="from_date" placeholder="{{__('formname.student.start_date')}}" class="form-control from_date_filter" autocomplete="off" value="">
                            </div>
                            <div class="col-sm-3">
                                <input type="text" name="to_date" placeholder="{{__('formname.student.end_date')}}" class="form-control to_date_filter" autocomplete="off" value="">
                            </div>
                            <div class="col-sm-3">
                                <a class="btn btn-success text-white" id='submitBtn' type="button">@lang('general.submit')</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="student_test_table" data-url="{{ route('student_test_datatable') }}">
                    <thead>
                        <tr>
