    ...
    <tr>
        <td>
            ...
            <table style="width: 100%;background-color: #ffffff; border: 1px solid #e0e0e0; max-width: 100%" align="left" border="0" cellpadding="10" cellspacing="0">
                ...
                <tr>
                    <td style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTest->questions}}</td>
                    <td style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTest->attempted ?? 0}}</td>
                    <td style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTest->correctly_answered ?? 0}}</td>
                    <td style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTest->unanswered ?? 0}}</td>
                    <td style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 13px !important;color: #2296f3 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTest->obtained_marks ?? 0}} out of {{@$studentTest->total_marks ?? 0}}</td>
                    <td style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 13px !important;color: #2296f3 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTest->overall_result ?? 0}}%</td>
                </tr>
                <tr>
                    ...
                    <td colspan="5" style="font-family: 'Poppins', sans-serif !important;font-weight: 600 !important;font-size: 15px !important;color: #000 !important;text-align: left !important;vertical-align: middle;">{{@$studentTest->rank}} out of {{@$totalStudentAttemptTest}}</td>
                </tr>
                </tbody>
            </table>
        </td>
                        ...
                        <table style="width: 100%;background-color: #ffffff; border: 1px solid #e0e0e0; max-width: 100%" align="left" border="0" cellpadding="10" cellspacing="0">
                            ...
                            @if($studentTest->studentResult)
                                ...
                                @forelse(@$studentTestQuestionAnswers as $key => $studentTestQuestionAnswer)
                                    ...
                                    @endphp
                                        <tr>
                                            <td style="font-family: 'Poppins', sans-serif !important;font-weight: 500 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$studentTestQuestionAnswer->questionList->question_no}}</td>
                                            ...
                                            <td style="font-family: 'Poppins', sans-serif !important;font-weight: 500 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{Str::limit(@$studentTestQuestionAnswer->questionList->topic->title,30)}}</td>
                                            @if($mockTest->stage_id == 1)
                                ...
                                @if(count($studentTestQuestionAnswers) == 0)
                                    @forelse (@$questionList as $question)
                                        <tr>
                                            <td style="font-family: 'Poppins', sans-serif !important;font-weight: 500 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$question->question->question_no}}</td>
                                            ...
                                            <td style="font-family: 'Poppins', sans-serif !important;font-weight: 500 !important;font-size: 13px !important;color: #000 !important;text-align: left !important;border: 1px solid #e0e0e0;">{{@$question->topic->title}}</td>
