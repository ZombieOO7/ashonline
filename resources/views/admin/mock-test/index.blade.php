...
@section('title', __('formname.mock-test.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.mock-test.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('mock-test.multi_delete')}}"
                                data-table_name="mock_test_table" data-module_name="Mock Exam">{{__('formname.submit')}}</a>
                            <button class="btn btn-info" style='margin:0px 0px 0px 12px' id='clr_filter'
                                data-table_name="mock_test_table">{{__('formname.clear_filter')}}</button>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <a href="{{Route('mock-test.create')}}"
                ...
                <!--begin: Datatable -->
                <table class="table table-striped table-bordered table-hover table-checkable for_wdth" id="mock_test_table"
                    data-url="{{ route('mock-test.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.mock-test.title')}}</th>
                            <th>{{__('formname.mock-test.exam_board_id')}}</th>
                            <th>{{__('formname.mock-test.grade_id')}}</th>
                            <th>{{__('formname.mock-test.start_date')}}</th>
                            <th>{{__('formname.mock-test.end_date')}}</th>
                            <th>{{__('formname.mock-test.price')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.mock-test.title')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.mock-test.exam_board_id')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.mock-test.grade_id')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.mock-test.start_date')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.mock-test.end_date')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.mock-test.price')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <h3 class="mdl_ttl">{{ __('formname.mock-test.title') }}</h3>
...
@section('inc_script')
<script>
var url = "{{ route('mock-test.datatable') }}";
/** Show description modal */
...
<script src="{{ asset('backend/js/mock-test/index.js') }}" type="text/javascript"></script>
@stop