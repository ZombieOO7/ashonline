        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-wrapper">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="{{route('question.index')}}" class="btn btn-secondary m-btn m-btn--air m-btn--custom">
                                    <span>
                    ...
                    <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post" action="{{route('question.importFile')}}" id="m_form_1" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="m-portlet__body">
                                     ...
                                     <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <div class="alert m-alert m-alert--default" role="alert">
                                                Download <a target="__blank" href="{{ URL('/public/uploads/mcq-sample.xls') }}">MCQ Question Sample</a>
                                            </div>
                                        </div>
                                        <div class="input-group">
                                            <div class="alert m-alert m-alert--default" role="alert">
                                                Download <a target="__blank" href="{{ URL('/public/uploads/standard-sample.xls') }}">Standard Question Sample</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
