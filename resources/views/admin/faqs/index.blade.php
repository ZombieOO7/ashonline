...
@section('content')
@section('title', __('formname.faq.name'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('faq_multi_delete')}}"
                                data-table_name="faq_table" data-module_name="FAQ">{{__('formname.submit')}}</a>
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth" id="faq_table"
                    data-type="" data-url="{{ route('faq_datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
...
@section('inc_script')
<script>
var url = "{{ route('faq_datatable') }}";
</script>
<script src="{{ asset('backend/js/faqs/index.js') }}" type="text/javascript"></script>
@stop