            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile"
                    ...
                    <div class="m-portlet__body">
                        ...
                        {{ Form::model($faq, ['route' => ['faq_store', @$faq->uuid], 'method' => 'PUT','id'=>'m_form_1','class'=>'m-form m-form--fit m-form--label-align-right','files' => true,'autocomplete' => "off"]) }}
                        @else
                        {{ Form::open(['route' => 'faq_store','method'=>'post','class'=>'m-form m-form--fit m-form--label-align-right','id'=>'m_form_1','files' => true,'autocomplete' => "off"]) }}
                        @endif
                            <div class="form-group m-form__group row">
                                {!! Form::label('faq_category_id',"FAQ Category <sup class='rqvr'>*</sup>" ,['class'=>'col-form-label col-lg-3
                                col-sm-12'],false) !!}
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    {!! Form::select('faq_category_id', @$faqCategories, @$faq->faq_category_id,
                                    ['id' => 'faq_category_id','class' =>'form-control','placeholder' => __('formname.select')]) !!}
                                    <span class="categoryErr">
                                    </span>
                                </div>                                
                            </div>                                                    
                            <div class="form-group m-form__group row">
