        ...
        <div class="col-md-12 mrgn_bt_30 mrgn_tp_30">
            ...
            <div class="col-lg-12 mrgn_bt_30">
                    ...
                    <div class="col-lg-4  order-1 order-lg-2">
                        ...
                        <ul class="blog_tabs">
                            <li><a class="active" href="@if($detailType == "blogs") {{ route('blogs/index') }} @else {{ route('resources/index', $detailType) }} @endif">{{ __('admin/resorces.all') }}</a></li>
                            @forelse (blogPaperCategory() as $key => $item)
                                <li><a class="filter" href="@if($detailType == "blogs") {{ route('blogs/index', $key) }} @else {{ route('resources/index', [$detailType, $key]) }} @endif" data-values="{{ $key }}">{{ $item }}</a></li>
                            @empty
                            @endforelse
                        </ul>
                        </div>
                ...
                <div class="blog-details latest_blog">
                    ...
                    <div class="row" id="all_blogs">
                        @include('frontend.blog.load_blog', ['blogs' => $latestBlog])
                    </div>
                </div>
