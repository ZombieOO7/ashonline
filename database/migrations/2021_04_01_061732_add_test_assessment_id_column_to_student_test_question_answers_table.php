...
class AddTestAssessmentIdColumnToStudentTestQuestionAnswersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('student_test_question_answers', function (Blueprint $table) {
            if (!Schema::hasColumn('student_test_question_answers', 'test_assessment_id')) {
    ...
    public function down()
    {
        Schema::table('student_test_question_answers', function (Blueprint $table) {
            if (Schema::hasColumn('student_test_question_answers', 'test_assessment_id')) {
                $table->dropForeign('student_test_question_answers_test_assessment_id_foreign');
