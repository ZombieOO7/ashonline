$(document).ready(function () {
    var url = $('#faq_table').attr('data-url'); // This variable is used for getting route name or url.
    ...
    (function ($) {
        ...
        c._listingView = function () {
            ...
            table = acePaperCommon._generateDataTable('faq_table', url, field_coloumns, order_coloumns, data = null);
        };
