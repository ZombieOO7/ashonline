$(document).ready(function () {
    var url = $('#topic_table').attr('data-url'); // This variable is used for getting route name or url.
    ...
    (function ($) {
        ...
        c._listingView = function () {
            ...
            backloadzCommon._generateDataTable('topic_table', url, field_coloumns, order_coloumns);
        };
