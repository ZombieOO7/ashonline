...
class PracticeQuestionList extends BaseModel
{
    /**
    ...
    protected $fillable = [
        ...
        'answer_image','explanation','topic_id','instruction','answer_type',
        'resize_full_image', 'resize_question_image', 'resize_answer_image'
     ...
     {
         return $this->hasMany('App\Models\PracticeAnswer', 'question_list_id')->orderBy('id');
     }
     ...
     {
         return $this->hasOne('App\Models\PracticeAnswer', 'question_list_id')->whereIsCorrect('1');
     }
     ...
     {
         return $this->belongsTo('App\Models\PracticeQuestion', 'question_id');
     }
 
     /**
      * Get that question average correct answer count
      */
     public function getAverageCorrectAnswerAttribute(){
         return $this->hasMany('App\Models\PracticeTestQuestionAnswer','question_list_id')
    ...
    /**
      * Get that question average incorrect answer count
    */
    ...
    */
    ...
    /**
      * Get that question average response count
    */
    ...
    */
    ...
    /**
      * Get that question total answer count
    */
    ...
    /**
      * Get that average unattempted answer count
    */
    public function getAverageUnattemptedAttribute(){
     ...
     {
         return $this->hasOne('App\Models\PracticeAnswer', 'question_list_id')->orderBy('id','desc');
     }
    ...
    */
    ...
    {
        return $this->hasMany('App\Models\PracticeAnswer', 'question_list_id')->whereIsCorrect('1')->orderBy('id','asc');
    }
}
