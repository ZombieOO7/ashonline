...
class AssessmentQuestionImport implements ToCollection
{
    /**
    ...
    public function collection(Collection $rows)
    {
        ...
        $validator = Validator::make($rows, 
                    [
                        ...
                        '*.10.required'=>'The first correct answer field is required.',
        ...
        foreach($multipleQuestionData as $paperKey=> $row){
            ...
            foreach($row['questionList'] as $r){
                ...
                $topic = null;
                if(isset($row['topic']) && @$row['topic'] != null && @$row['topic'] != ''){
                ...
                $questionData = PracticeByTopicQuestion::create([
                    'uuid' => \Str::uuid(),
                ...
                for($i=1; $i <=$limit; $i++ ){
                    ...
                    if($r[$j] != null){
                        $answerData = PracticeByTopicAnswer::create([
